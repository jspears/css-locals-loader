...
describe('transition', function () {
    it('.transition.toString', function () {
        ...
        expect(t).toBe('transition: height 2000 ease, max-width 3000 ease-in 1000, opacity 100 ease 1000');
    });
    ...
    it('.transition.duration', function () {
        ...
        expect(r).toBe('transition: height 1000 ease, max-width 1000 ease-in 1000, opacity 1000 ease 1000');
    });

    it('.transition opacity .1s 1s', function () {
        var t = transition('opacity .1s 1s');
        expect(t + '').toBe('transition: opacity 100 ease 1000');
    });
    ...
    it('.transition.delay and check timeout', function () {
        ...
        expect(''+r).toBe('transition: height 2000 ease 333, max-width 3000 ease-in 333, opacity 100 ease 333');
    });
    it('.wrong order', function () {
        ...
        expect(''+r).toBe('transition: stuff 111 cubic 333, more 2000 linear 333, other 111 cubic 333');
